    ...
    <div className="min-h-screen bg-[#0D0D10] flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#111116] border border-white/[0.07] rounded-2xl shadow-2xl p-6">
          <div className="mb-5">
            <h1 className="font-syne text-[18px] font-bold text-white">Sign in</h1>
            <p className="text-[12px] text-white/30 mt-0.5">Enter your credentials to continue</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-[11px] font-semibold text-white/40 uppercase tracking-wider mb-1.5">Username</label>
              <input
                value={username}
            ...
            <button
              ...
              className="w-full py-2.5 rounded-lg bg-violet-600 hover:bg-violet-500 text-white text-[13px] font-semibold transition-all shadow-[0_0_20px_rgba(108,92,231,.35)] hover:shadow-[0_0_28px_rgba(108,92,231,.45)] disabled:opacity-50 disabled:cursor-not-allowed"
            >
