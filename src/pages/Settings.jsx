...
export default function Settings() {
  ...
  async function handleReset() {
    ...
    try {
      if (USE_MOCK) {
        showToast('Mock mode: no DB to reset', 'info')
        return
      }
  ...
  return (
    <div className="animate-[fadeUp_.3s_ease] max-w-xl">
      <div className="mb-6">
        <h1 className="font-syne text-[22px] font-extrabold text-white tracking-tight">Settings</h1>
        <p className="text-[12px] text-white/30 mt-1">App configuration and database tools</p>
      </div>
      ...
      {/* Version info */}
      <div className="mt-4 flex items-center gap-3 text-[11px] text-white/15 font-mono px-1">
