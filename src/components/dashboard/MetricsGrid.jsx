...
export default function MetricsGrid({ activeCreators, dueThisWeek, overdue, completionRate, pendingRecruits }) {
  const metrics = [
    { icon: Users,       label: 'Active Creators',  val: activeCreators,       delta: 'Non-rejected, active',  deltaColor: 'text-white/25',    iconBg: 'bg-violet-400/15 text-violet-300' },
    { icon: Calendar,    label: 'Due This Week',     val: dueThisWeek,          delta: 'In progress or pending', deltaColor: 'text-amber-300',   iconBg: 'bg-amber-400/12 text-amber-300' },
    ...
    { icon: TrendingUp,  label: 'Completion Rate',   val: `${completionRate}%`, delta: 'Tasks completed',        deltaColor: 'text-white/25',    iconBg: 'bg-emerald-400/12 text-emerald-400' },
