...
export default function CreatorSidebar() {
  ...
  return (
    <aside className="w-[228px] bg-[#111116] border-r border-white/7 flex flex-col flex-shrink-0">
      {/* Logo */}
      <div className="px-4 py-5 border-b border-white/7 flex-shrink-0">
      ...
      {/* Footer */}
      <div className="p-2.5 border-t border-white/7 flex-shrink-0 space-y-1">
        <NavLink to="/portal/account" className={LINK}>
