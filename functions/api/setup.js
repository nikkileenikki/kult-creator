...
export async function onRequestGet({ env }) {
  ...
  const steps = [
    ...
    { name: 'Add last_login_at to users',                sql: `ALTER TABLE users ADD COLUMN last_login_at      TEXT NOT NULL DEFAULT ''` },
    { name: 'Add last_login_ip to users',                sql: `ALTER TABLE users ADD COLUMN last_login_ip      TEXT NOT NULL DEFAULT ''` },
